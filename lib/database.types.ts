...
export interface Database {
  public: {
    Tables: {
      ...
      work_orders: {
        Row: { id: string; sales_order_id: string | null; design_id: string | null; design_name: string | null; raw_materials_used: Json; materials_issued: Json; labor_hours: number; labor_cost: number; overhead_cost: number; total_cost: number; estimated_cost: number; status: string; assigned_worker: string | null; completionPercentage: number; notes: string | null; start_time: string | null; estimated_completion: string | null; completed_at: string | null; created_at: string; updated_at: string }
        Insert: { id?: string; sales_order_id?: string | null; design_id?: string | null; design_name?: string | null; raw_materials_used?: Json; materials_issued?: Json; labor_hours?: number; labor_cost?: number; overhead_cost?: number; total_cost?: number; estimated_cost?: number; status?: string; assigned_worker?: string | null; completionPercentage?: number; notes?: string | null; start_time?: string | null; estimated_completion?: string | null; completed_at?: string | null; created_at?: string; updated_at?: string }
        Update: { id?: string; sales_order_id?: string | null; design_id?: string | null; design_name?: string | null; raw_materials_used?: Json; materials_issued?: Json; labor_hours?: number; labor_cost?: number; overhead_cost?: number; total_cost?: number; estimated_cost?: number; status?: string; assigned_worker?: string | null; completionPercentage?: number; notes?: string | null; start_time?: string | null; estimated_completion?: string | null; completed_at?: string | null; created_at?: string; updated_at?: string }
      }
      inventory_items: {
