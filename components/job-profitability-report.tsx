              ...
              <CardContent className="pt-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {formatCurrency(highMarginJobs.reduce((sum: number, job: any) => sum + job.gross_profit, 0))} profit
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {formatCurrency(mediumMarginJobs.reduce((sum: number, job: any) => sum + job.gross_profit, 0))} profit
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-4">
                <div className="text-center">
                  ...
                  <div className="text-xs text-muted-foreground">
                    {formatCurrency(lowMarginJobs.reduce((sum: number, job: any) => sum + job.gross_profit, 0))} profit
                  </div>
                </div>
              </CardContent>
            </Card>
